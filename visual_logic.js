...
var animation_map, mobile, x, y, truck_details, prev_step, loop_calculations, i, target_step, containers_materials, prev_container, current_frame, t, target_frame, step, containers_frames_map, animation, loop_time, wave_train, v, containers_list, trains_models, delta, dust_empties, scroll_animation_list, fov, dust_particles;
...
'    // если нажата цифра 0–9 go_to_step' + '\n' +
...
'' + '\n' +
'  // Вызов процедуры с двумя аргументами' + '\n' +
